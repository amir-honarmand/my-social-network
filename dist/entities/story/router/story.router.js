...
const delete_story_dto_1 = require("../dto/delete-story.dto");
...
storyRouter.route('/op/:storyId')
    ...
    .delete(auth_1.default.userAuthMiddleware, (0, dtoValidator_1.dtoValidator)(delete_story_dto_1.DeleteStoryDto), story_controller_1.default.deleteStory);
